...
export const TAFSIR_DATA: TafsirEntry[] = [
  {
    ...
    anchorOffsetX: 0.04, // Left/Right positioning in 3D (Tweaked for verse 3)
    anchorOffsetY: 0.04, // Up/Down fine-tuning relative to the bone
  ...
  },
  {
    ...
    scrollEnd: 0.9,
    boneIndex: 45,
    anchorOffsetX: -0.4, // Negative moves it left in 3D space
    anchorOffsetY: -0.3,
