        ...
        {showMedia && (
          ...
          >
            ...
            <div className="absolute inset-0 z-0 scale-[1.6] in-[.dark]:scale-[1.4] opacity-100 in-[.dark]:opacity-60 blur-[100px] in-[.dark]:blur-[80px] saturate-200 in-[.dark]:saturate-150 pointer-events-none mix-blend-screen transform-gpu origin-center">
              <MediaElement src={src} isVideo={isVideo} className="[filter:hue-rotate(20deg)_sepia(50%)_saturate(150%)_brightness(120%)] in-[.dark]:[filter:none]" />
            </div>
            ...
            >
              <MediaElement src={src} isVideo={isVideo} style={verticalMask} className="[filter:hue-rotate(20deg)_sepia(50%)_saturate(150%)_brightness(120%)] in-[.dark]:[filter:none]" />
