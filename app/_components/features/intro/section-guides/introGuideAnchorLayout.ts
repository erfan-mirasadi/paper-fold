...
import type { useSurahLayoutRuntime } from "../../../data/useSurahLayoutRuntime";
import type { ElevatedSectionId } from "../../elevated-verses/useElevatedStore";
...
export const LABEL_GUIDE_TOP_OFFSET_Y =
  TOP_LABEL_BODY_H / 2 + TOP_LABEL_BORDER;
