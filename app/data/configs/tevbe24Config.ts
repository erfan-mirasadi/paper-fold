...
export const TEVBE_24_CONFIG: SurahLayoutConfig = {
  ...
  verseOverrides: {
    ...
    2: shield(),
    3: shield(),
    4: shield({ verseShape: "dome-down", domeSideRatio: 0.2, expandH: 0.02 }),

    // ── LEFT shield 5-6-7 ─────────────────────────────────────────────────
    5: shield(),
    6: shield(),
    7: shield({ verseShape: "dome-down", domeSideRatio: 0.2, expandH: 0.02 }),
    ...
    11: {
      ...
      border: TEAL_BORDER,
      circleBg: TEAL_BG,
      circleBorderCol: TEAL_BORDER,
      circleTextCol: "#2F5B5F",
      textColor: "#1F4A4E",
      isPill: false,
    },
    12: {
      bg: MAROON_BG,
      border: MAROON_BORDER,
      circleBg: MAROON_BG,
      circleBorderCol: MAROON_BORDER,
